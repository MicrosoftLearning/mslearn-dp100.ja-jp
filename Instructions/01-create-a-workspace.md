...
2. **コンピューティング インスタンス** タブで、次の設定を使用して新しいコンピューティング インスタンスを追加します。これをワークステーションとして使用し、ノートブックでコードを実行します。
    ...
    - **利用可能なクォータの合計**: これは、使用可能な専用コアを示しています。
...
3. 「**ターミナル**」または「**ターミナルを開く**」を選択して、ターミナルを開き、その**コンピューティング**がコンピューティング インスタンスに設定されていること、また現在のパスが **/users/your-user-name** フォルダーであることを確認します。
