...
ms.locfileid: "137894563"
---
# <a name="monitor-data-drift"></a>データ ドリフトを監視する

時間の経過と共にデータの傾向が変化すると、モデルによる予測の精度が低下する可能性があります。 この *データ ドリフト* の監視と必要に応じた再トレーニングは、機械学習ソリューションが確実に正確な予測を続けられるようにするための重要な方法です。
...
## <a name="monitor-data-drift-for-a-dataset"></a>データセットのデータ ドリフトを監視する
...
Azure Machine Learning での作業が終わったら、Azure Machine Learning スタジオの **[コンピューティング]** ページで、 **[コンピューティング インスタンス]** タブを選択し、 **[停止]** をクリックしてシャットダウンします。
