...
ms.locfileid: "137894562"
---
# <a name="create-a-real-time-inference-service"></a>リアルタイム推論サービスを作成する
...
## <a name="create-a-real-time-inferencing-service"></a>リアルタイム推論サービスを作成する
